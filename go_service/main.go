...
const (
	...
	DISTANCE    = "200km"
	ES_URL      = "http://34.123.196.38:9200"
	BUCKET_NAME = "post-images-gogogo"
)
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	lat, _ := strconv.ParseFloat(r.URL.Query().Get("lat"), 37)
	lon, _ := strconv.ParseFloat(r.URL.Query().Get("lon"), 121)
	// range is optional
	ran := DISTANCE
